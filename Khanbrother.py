...
\033[1;98m║✯ KHAN x BROTHER            ║  
\033[1;96m║✯ I'm Not Responsible For Any Miss Use Mr. Bro ║
\033[1;92m║══▒═✺═▒═✺═▒═══¤═¤═¤════════════¤═══║"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://youtube.com/channel/UCaDycv8l8cGtCzIYR8ukEvg')
    else:
        print "\033[1;96mWrong Username"
        os.system('xdg-open https://m.youtube.com/youtube.com/channel/UCaDycv8l8cGtCzIYR8ukEvg')
